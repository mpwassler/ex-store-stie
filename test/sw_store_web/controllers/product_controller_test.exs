defmodule SwStoreWeb.ProductControllerTest do
  use SwStoreWeb.ConnCase
  ...
  describe "index" do
    test "lists all catalog_products", %{conn: conn} do
      conn = get(conn, Routes.product_path(conn, :index))
      assert html_response(conn, 200) =~ "Listing Catalog products"
    end
  end
